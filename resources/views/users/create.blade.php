        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-5 sm:px-8 sm:py-6">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-white">Ajouter un Nouvel Utilisateur</h2>
                        <p class="mt-1 text-blue-100">Remplissez les informations nécessaires pour créer un nouveau compte</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input type="text" name="first_name" id="first_name" 
                                           class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 transition duration-150 ease-in-out" 
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="email" name="email" id="email" 
                                           class="block w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 transition duration-150 ease-in-out" 
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input type="password" name="password" id="password" 
                                           class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 transition duration-150 ease-in-out" required>
                                </div>
                            </div>
